...
def model_config(parser):
    ...
    # parser.add_argument('--encoder_type', type=int, default=EncoderModelType.ROBERTA)
    parser.add_argument('--num_hidden_layers', type=int, default=-1)

    # BERT pre-training
    parser.add_argument('--bert_model_type', type=str, default='bert-base-uncased')
    # parser.add_argument('--bert_model_type', type=str, default='roberta-base')
...
def data_config(parser):
    ...
    parser.add_argument("--init_checkpoint", default='bert/bert_model_base_uncased.pt', type=str)
    # parser.add_argument("--init_checkpoint", default='roberta.base', type=str)
    parser.add_argument('--data_dir', default='data/canonical_data/bert_uncased_lower')
    # parser.add_argument('--data_dir', default='data/canonical_data/roberta_base_cased')
